...
<div class="w-full flex-1 p-4 sm:p-6 space-y-8">
    ...
    <section id="courts" class="bg-gray-900 rounded-xl shadow p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-6">
            ...
            <a href="{{ route('admin.addcourtForm') }}" class="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded">
                + Add Court
            </a>
        </div>
        ...
        <div class="mt-6 text-right">
            <a href="{{ route('admin.mycourts') }}" class="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-5 py-2 rounded-md shadow transition duration-300">
                View All
            </a>
        </div>
    </section>
    ...
    <section id="bookings" class="bg-gray-900 rounded-xl shadow p-6">
        ...
        <!-- View All Button -->
        <div class="mt-6 text-right">
            <a href="{{ route('admin.bookings') }}" class="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-5 py-2 rounded-md shadow transition duration-300">
                View All
            </a>
        </div>
    </section>
    ...
    <section id="users" class="bg-gray-900 rounded-xl shadow p-6">
        ...
        <ul class="divide-y divide-gray-800">
            @forelse ($userManagement as $user)
                <li class="py-2 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                  <div>
        ...
        <!-- View All Button -->
        <div class="mt-6 text-right">
            <a href="{{ route('admin.users') }}" class="inline-block bg-green-600 hover:bg-green-700 text-white font-medium px-5 py-2 rounded-md shadow transition duration-300">
                View All
            </a>
        </div>
    </section>
