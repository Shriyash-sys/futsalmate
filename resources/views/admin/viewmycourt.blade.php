...
<div class="min-h-screen bg-gray-950 py-12 px-6">
    <div class="max-w-3xl mx-auto bg-gray-800 text-white rounded-2xl shadow-lg p-10">
        <h1 class="text-3xl font-bold mb-8 border-b border-gray-700 pb-4">Court Details</h1>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2">
                @if($court->image_path)
                    <img src="{{ asset('storage/' . $court->image_path)}}" alt="Court Image" class="w-full h-64 object-cover rounded-lg border border-gray-700 shadow">
                @else
        ...
        <div class="mt-10 flex justify-between">
            <a href="{{ route('admin.mycourts') }}" class="bg-gray-600 hover:bg-gray-500 text-white px-6 py-2 rounded-lg">
                Back
            </a>
            <a href="{{ route('admin.editMyCourtForm', $court->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-2 rounded-lg">
                Edit Court
            </a>
        </div>
    </div>
