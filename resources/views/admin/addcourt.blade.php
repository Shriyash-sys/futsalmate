...
<div class="w-full min-h-screen bg-gray-950 flex justify-center pt-10 mt-16 lg:mt-0 px-4 sm:px-6 md:px-8">
    <div class="w-full max-w-3xl bg-gray-900 p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg">
        ...
        <!-- Page Title -->
        <h2 class="text-2xl sm:text-3xl font-bold mb-8 text-center text-white">Add New Futsal Court</h2>
