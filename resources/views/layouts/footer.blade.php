        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="courts.html" class="text-gray-400 hover:text-primary transition duration-300">Courts</a></li>
                    <li><a href="pricing.html" class="text-gray-400 hover:text-primary transition duration-300">Pricing</a></li>
