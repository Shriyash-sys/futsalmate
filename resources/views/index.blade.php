        ...
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-10 md:mb-0">
                ...
                <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="booking.html" class="bg-primary hover:bg-primary-dark text-secondary font-bold py-3 px-6 rounded-lg transition duration-300 text-center">Book Now</a>
                    <a href="register.html" class="bg-transparent hover:bg-white/10 border-2 border-primary text-primary font-bold py-3 px-6 rounded-lg transition duration-300 text-center">Sign Up</a>
                </div>
            </div>
            <div class="md:w-1/2">
...
<section class="py-16 bg-white">
  ...
  <section class="py-16 bg-secondary text-white">
      <div class="container mx-auto px-4 text-center">
          ...
          <p class="text-lg mb-8 max-w-2xl mx-auto">Join hundreds of futsal enthusiasts who book with Futsal Mate. Easy booking, great courts, and flexible payment options.</p>
          <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <a href="booking.html" class="bg-primary hover:bg-primary-dark text-secondary font-bold py-3 px-6 rounded-lg transition duration-300">Book a Court</a>
              <a href="{{route('signupForm')}}" class="bg-transparent hover:bg-white/10 border-2 border-primary text-primary font-bold py-3 px-6 rounded-lg transition duration-300">Create Account</a>
          </div>
      </div>
  </section>
