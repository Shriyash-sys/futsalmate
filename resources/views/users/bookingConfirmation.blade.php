                    ...
                    <div class="max-w-3xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                            ...
                            <div class="bg-gray-50 px-4 py-5 sm:px-6 flex flex-col sm:flex-row gap-4 justify-end">
                                <a href="{{ route('userDashboard', auth()->user()->id) }}" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-secondary bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                    Go to Dashboard
                                </a>
                                <a href="{{route('mybookings', auth()->user()->id)}}" class="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                                    View All Bookings
                                </a>
                            </div>
                        </div>
